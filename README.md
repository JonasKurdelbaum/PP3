...
<details>
    ...
    When you create a new PDF file use the command pdflatex -jobname=[NAME].pdf main.tex
</details>
...
<details>
    ...
    if you change your documentclass to book, the document adds another page with the content and on the first page is just the title, date and name
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
    With this addition to main.tex a new headline with the Title Intro was added
</details>
...
<details>
    ...
    <code>
    You can add a list with the command:
    :let mylist = []
    </code>
</details>
